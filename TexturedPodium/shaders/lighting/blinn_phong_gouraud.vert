...
void main() {	
    ...
    vec3 ambient = light.ambient * material.ambient * light.ambient_strength * attenuation; 
    vec3 diffuse = light.diffuse * material.diffuse * norm_d_light * attenuation;
    vec3 specular = light.specular * (pow(max(dot(normal, half_dir), 0.0), material.sheen_coef) 
