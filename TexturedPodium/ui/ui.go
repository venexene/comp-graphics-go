// Пакет ui — текстовый интерфейс. Выводит панель управления в stdout
// при запуске. Заголовок окна обновляется в cmd/main.go.
// В перспективе может быть заменён на ImGui.
package ui
...
// LightingControlState — состояние панели UI (зарезервировано).
