...
void main() {
    ...
    vec3 ambient = light.ambient * surfaceColor * material.ambient * light.ambient_strength * attenuation; 
    vec3 diffuse = light.diffuse * surfaceColor * material.diffuse * norm_d_light * attenuation;
