...
// UniformCache stores OpenGL uniform locations for a shader program.
// Locations are refreshed once per program switch, avoiding
// expensive GetUniformLocation calls every frame.
...
// Refresh queries the current shader program for all uniform locations.
